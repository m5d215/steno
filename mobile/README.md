...
[steno](https://github.com/m5d215/steno)(macOS 版)の兄弟。steno がシステム音声＋マイクの二層を
Core Audio process tap で扱うのに対し、iOS は tap が無いので**マイク一本の環境音**に割り切る。
代わりに「ローカルに書いた発話を別マシンへ送る」転送層を持つ。
